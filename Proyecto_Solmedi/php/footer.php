    ...
    <div class="container">
        <footer class="py-3 my-4">
          <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                <li class="nav-item"><a href="http://localhost/Proyecto/pages/inicio_Solmedi.php" class="nav-link px-2 text-muted">INICIO</a></li>
                ...
                <li class="nav-item"><a href="https://www.who.int/es" class="nav-link px-2 text-muted">NOTICIAS OMS</a></li>
            </ul>
            <p class="text-center text-muted">© 2022 M.R.M.S., SAS</p>
        </footer>
    </div>
